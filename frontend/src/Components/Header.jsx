      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="md:hidden p-2 rounded-md bg-emerald-900 hover:bg-emerald-700 dark:hover:bg-emerald-800"
        ...
        <div className="md:hidden border-t bg-white dark:bg-[#020f0b] p-4 space-y-3 transition-all">
          {["problems", "contests", "tutorials", "discuss", "ask"].map((p) => (
            <Link
              ...
              className="block text-emerald-700 dark:text-gray-200 hover:text-green-800 transition py-2"
            >
              {p.charAt(0).toUpperCase() + p.slice(1)}
            </Link>
          ))}
            ...
            {!isAuthenticated ? (
              ...
              <>
                <div className="flex items-center gap-2 px-4 py-2 text-gray-700 dark:text-gray-200">
                  ...
                  {user?.role === "admin" && (
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 text-xs bg-green-100 text-green-800 dark:bg-green-800  dark:text-green-100 rounded-full ml-2">
                      <Shield size={10} />
                      Admin
                    </span>
                  )}
